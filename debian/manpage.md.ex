% apt-transport-gitlfs(SECTION) | User Commands
%
% "April  5 2022"
...
apt-transport-gitlfs - program to do something

# SYNOPSIS

**apt-transport-gitlfs** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**apt-transport-gitlfs** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **apt-transport-gitlfs** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**apt-transport-gitlfs** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    apt-transport-gitlfs. See **foo.conf**(5) for further details.
...
**apt-transport-gitlfs** provides some return codes, that can be used in scripts:
